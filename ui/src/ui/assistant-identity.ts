...
declare global {
  interface Window {
    __ClosedClaw_ASSISTANT_NAME__?: string;
    __ClosedClaw_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__ClosedClaw_ASSISTANT_NAME__,
    avatar: window.__ClosedClaw_ASSISTANT_AVATAR__,
  });
}
