...
test("3 consecutive failures → trust resets to 0.0", () => {
  ...
  for (let i = 0; i < 20; i++) {
    recordExecution("tool_fail", true);
  }
...
test("2 consecutive failures do NOT reset trust", () => {
  clean();
  for (let i = 0; i < 20; i++) {
    recordExecution("tool_2fail", true);
  }
...
test("success resets consecutive failure counter", () => {
  clean();
  for (let i = 0; i < 20; i++) {
    recordExecution("tool_reset", true);
  }
...
test("failures reduce trust via success ratio weighting", () => {
  ...
  for (let i = 0; i < 8; i++) {
    recordExecution("tool_ratio", true);
  }
  for (let i = 0; i < 2; i++) {
    recordExecution("tool_ratio", false);
  }
  ...
  clean();
  for (let i = 0; i < 10; i++) {
    recordExecution("tool_pure", true);
  }
...
test("unknown tool has higher risk than trusted tool", () => {
  ...
  for (let i = 0; i < 100; i++) {
    recordExecution("read_file", true);
  }
...
test("resetTrust() clears all tools", () => {
  clean();
  for (let i = 0; i < 10; i++) {
    recordExecution("a", true);
  }
  for (let i = 0; i < 10; i++) {
    recordExecution("b", true);
  }
  resetTrust();
