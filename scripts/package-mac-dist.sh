...
# Output:
# - dist/ClosedClaw.app
# - dist/ClosedClaw-<version>.zip
# - dist/ClosedClaw-<version>.dmg
...
APP="$ROOT_DIR/dist/ClosedClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/ClosedClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/ClosedClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ClosedClaw-$VERSION.notary.zip"
