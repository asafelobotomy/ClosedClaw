...
read_when:
  - You are building a ClosedClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (ClosedClaw.plugin.json)

Every plugin **must** ship a `ClosedClaw.plugin.json` file in the **plugin root**.
ClosedClaw uses this manifest to validate configuration **without executing plugin
