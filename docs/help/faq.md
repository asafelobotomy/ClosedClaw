---
summary: "Frequently asked questions about ClosedClaw setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up ClosedClaw?](#whats-the-recommended-way-to-install-and-set-up-ClosedClaw)
  ...
  - [I can't access docs.ClosedClaw.ai (SSL error). What now?](#i-cant-access-docsClosedClawai-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or ClosedClaw not recognized](#windows-install-says-git-not-found-or-ClosedClaw-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install ClosedClaw on Linux?](#how-do-i-install-ClosedClaw-on-linux)
  - [How do I install ClosedClaw on a VPS?](#how-do-i-install-ClosedClaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask ClosedClaw to update itself?](#can-i-ask-ClosedClaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run ClosedClaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-ClosedClaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different ClosedClaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-ClosedClaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run ClosedClaw on a dedicated machine?](#how-important-is-it-to-run-ClosedClaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run ClosedClaw in a VM and what are the requirements](#can-i-run-ClosedClaw-in-a-vm-and-what-are-the-requirements)
- [What is ClosedClaw?](#what-is-ClosedClaw)
  - [What is ClosedClaw, in one paragraph?](#what-is-ClosedClaw-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for ClosedClaw](#what-are-the-top-five-everyday-use-cases-for-ClosedClaw)
  - [Can ClosedClaw help with lead gen outreach ads and blogs for a SaaS](#can-ClosedClaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can ClosedClaw run tasks on a schedule or continuously in the background?](#can-ClosedClaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with ClosedClaw saved locally?](#is-all-data-used-with-ClosedClaw-saved-locally)
  - [Where does ClosedClaw store its data?](#where-does-ClosedClaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall ClosedClaw?](#how-do-i-completely-uninstall-ClosedClaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the ClosedClaw browser run headless?](#can-the-ClosedClaw-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two ClosedClaw instances talk to each other (local + VPS)?](#can-two-ClosedClaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does ClosedClaw load environment variables?](#how-does-ClosedClaw-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of ClosedClaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-ClosedClaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset ClosedClaw but keep it installed?](#how-do-i-completely-reset-ClosedClaw-but-keep-it-installed)
  ...
  - [Why doesn’t ClosedClaw reply in a group?](#why-doesnt-ClosedClaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do ClosedClaw, Flawd, and Krill use for models?](#what-do-ClosedClaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `ClosedClaw gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-ClosedClaw-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `ClosedClaw gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-ClosedClaw-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run ClosedClaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-ClosedClaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart ClosedClaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-ClosedClaw)
  ...
  - [ELI5: `ClosedClaw gateway restart` vs `ClosedClaw gateway`](#eli5-ClosedClaw-gateway-restart-vs-ClosedClaw-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose ClosedClaw to inbound DMs?](#is-it-safe-to-expose-ClosedClaw-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/ClosedClaw/ClosedClaw-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ```bash
   ClosedClaw health --json
   ClosedClaw health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://ClosedClaw.ai/install.sh | bash -s -- --install-method git
```

This installs ClosedClaw **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/ClosedClaw/ClosedClaw/issues
https://github.com/ClosedClaw/ClosedClaw/pulls

Start with these commands (share outputs when asking for help):

```bash
ClosedClaw status
ClosedClaw models status
ClosedClaw doctor
```

What they do:

- `ClosedClaw status`: quick snapshot of gateway/agent health + basic config.
- `ClosedClaw models status`: checks provider auth + model availability.
- `ClosedClaw doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `ClosedClaw status --all`, `ClosedClaw logs --follow`,
`ClosedClaw gateway status`, `ClosedClaw health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up ClosedClaw

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://ClosedClaw.ai/install.sh | bash
...
If you don’t have a global install yet, run it via `pnpm ClosedClaw onboard`.
...
1. Install ClosedClaw on the new machine.
2. Copy `$ClosedClaw_STATE_DIR` (default: `~/.ClosedClaw`) from the old machine.
3. Copy your workspace (default: `~/.ClosedClaw/workspace`).
4. Run `ClosedClaw doctor` and restart the Gateway service.
...
under `~/.ClosedClaw/` (for example `~/.ClosedClaw/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-ClosedClaw-store-its-data),
...
https://github.com/ClosedClaw/ClosedClaw/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.ClosedClaw.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.ClosedClaw.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.ClosedClaw.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsClosedClawai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/ClosedClaw/ClosedClaw/tree/main/docs
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://ClosedClaw.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://ClosedClaw.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://ClosedClaw.ai/install.ps1
...
```bash
curl -fsSL https://ClosedClaw.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://ClosedClaw.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://ClosedClaw.ai/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or ClosedClaw not recognized
...
**2) ClosedClaw is not recognized after install**
...
### How do I install ClosedClaw on Linux
...
### How do I install ClosedClaw on a VPS
...
### Can I ask ClosedClaw to update itself
...
```bash
ClosedClaw update
ClosedClaw update status
ClosedClaw update --channel stable|beta|dev
ClosedClaw update --tag <dist-tag|version>
ClosedClaw update --no-restart
```

If you must automate from an agent:

```bash
ClosedClaw update --yes --no-restart
ClosedClaw gateway restart
```
...
`ClosedClaw onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run ClosedClaw with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `ClosedClaw models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `ClosedClaw models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `ClosedClaw models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. ClosedClaw no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so ClosedClaw can keep replying while a provider is rate‑limited.
...
ClosedClaw supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. ClosedClaw fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `ClosedClaw.json`.

Steps:

1. Enable the plugin: `ClosedClaw plugins enable google-gemini-cli-auth`
2. Login: `ClosedClaw models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. ClosedClaw needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. ClosedClaw runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. ClosedClaw’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run ClosedClaw can I connect it to my MacBook Pro
...
- Use `ClosedClaw nodes status` / `ClosedClaw nodes list` to see it.
...
- DM your bot, then run `ClosedClaw logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different ClosedClaw instances
...
If you run ClosedClaw via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the ClosedClaw code install. Your state
(`~/.ClosedClaw`) and workspace (`~/.ClosedClaw/workspace`) stay untouched.
...
**ClosedClaw-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run ClosedClaw on a dedicated machine
...
ClosedClaw is lightweight. For a basic Gateway + one chat channel:
...
### Can I run ClosedClaw in a VM and what are the requirements
...
### What is ClosedClaw in one paragraph

ClosedClaw is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

ClosedClaw is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for ClosedClaw
...
### Can ClosedClaw help with lead gen outreach ads and blogs for a SaaS
...
ClosedClaw draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

ClosedClaw is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use ClosedClaw when you
...
Showcase: https://ClosedClaw.ai/showcase

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.ClosedClaw/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.ClosedClaw/ClosedClaw.json`). Precedence is `<workspace>/skills` > `~/.ClosedClaw/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.ClosedClaw/ClosedClaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.ClosedClaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which ClosedClaw treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `ClosedClaw_SKIP_CRON` is not set.
...
```bash
ClosedClaw cron run <jobId> --force
ClosedClaw cron runs --id <jobId> --limit 50
```
...
### Can ClosedClaw run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.ClosedClaw.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-ClosedClaw-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. ClosedClaw can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.ClosedClaw/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: { "ClosedClaw": { "os": ["darwin", "linux"], "requires": { "bins": ["imsg"] } } }
   ---
   ```
4. Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (ClosedClaw only needs stdio). See [iMessage](/channels/imessage).
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured ClosedClaw workspace); ClosedClaw treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.ClosedClaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `ClosedClaw_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `ClosedClaw_DOCKER_APT_PACKAGES`.
...
ClosedClaw memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

ClosedClaw also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, ClosedClaw auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, ClosedClaw
prefers `local`.
...
### Is all data used with ClosedClaw saved locally

No - **ClosedClaw’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.ClosedClaw` + your workspace directory).
...
### Where does ClosedClaw store its data
...
| `$ClosedClaw_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$ClosedClaw_STATE_DIR/agents/`                                   | Per‑agent state (agentDir + sessions)                        |
| `$ClosedClaw_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$ClosedClaw_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single‑agent path: `~/.ClosedClaw/agent/*` (migrated by `ClosedClaw doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.ClosedClaw/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.ClosedClaw`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.ClosedClaw`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.ClosedClaw/skills`).

Default workspace is `~/.ClosedClaw/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.ClosedClaw/workspace" } },
}
```
...
Do **not** commit anything under `~/.ClosedClaw` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall ClosedClaw
...
`workspace` to the repo root. The ClosedClaw repo is just source code; keep the
...
ClosedClaw reads an optional **JSON5** config from `$ClosedClaw_CONFIG_PATH` (default: `~/.ClosedClaw/ClosedClaw.json`):

```
$ClosedClaw_CONFIG_PATH
```

If the file is missing, it uses safe‑ish defaults (including a default workspace of `~/.ClosedClaw/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `ClosedClaw_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `ClosedClaw doctor --generate-gateway-token`.
...
key. **Recommended:** run `ClosedClaw configure --section web` to store it in
...
- Daemons read env vars from `~/.ClosedClaw/.env` (or the service environment).
...
### Can the ClosedClaw browser run headless
...
- Gateway is running: `ClosedClaw gateway status`
- Gateway health: `ClosedClaw status`
- Channel health: `ClosedClaw channels status`
...
### Can two ClosedClaw instances talk to each other local VPS
...
`ClosedClaw agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
ClosedClaw agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.ClosedClaw/ClosedClaw.json`).
- If you have no backup, re-run `ClosedClaw doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `ClosedClaw config set` for small changes.
- Use `ClosedClaw configure` for interactive edits.
...
```bash
ClosedClaw gateway --tailscale serve
```
...
### How does ClosedClaw load environment variables

ClosedClaw reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.ClosedClaw/.env` (aka `$ClosedClaw_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.ClosedClaw/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`ClosedClaw_LOAD_SHELL_ENV=1`, `ClosedClaw_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`ClosedClaw models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means ClosedClaw won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.ClosedClaw/.env`:
   ```
...
### Is there a way to make a team of ClosedClaw instances one CEO and many agents
...
### How do I completely reset ClosedClaw but keep it installed
...
```bash
ClosedClaw reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `ClosedClaw_PROFILE`), reset each state dir (defaults are `~/.ClosedClaw-<profile>`).
- Dev reset: `ClosedClaw gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), ClosedClaw skips the heartbeat run to save API calls.
...
No. ClosedClaw runs on **your own account**, so if you’re in the group, ClosedClaw can see it.
...
```bash
ClosedClaw directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt ClosedClaw reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.ClosedClaw/agents/<agentId>/sessions/`.
...
- Use `ClosedClaw doctor` to spot stray workspaces and profile mismatches.
...
ClosedClaw’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, ClosedClaw currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `ClosedClaw models set ...` (updates just model config)
- `ClosedClaw configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.ClosedClaw/ClosedClaw.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `ClosedClaw doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do ClosedClaw, Flawd, and Krill use for models

- **ClosedClaw + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-5`) - see [Anthropic](/providers/anthropic).
...
Yes. ClosedClaw ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.ClosedClaw/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `ClosedClaw agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so ClosedClaw can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.ClosedClaw/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.ClosedClaw/agent/*` (migrated by `ClosedClaw doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.ClosedClaw/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `ClosedClaw models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `ClosedClaw models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `ClosedClaw models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.ClosedClaw/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    ClosedClaw models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), ClosedClaw will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: ClosedClaw now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
ClosedClaw uses provider‑prefixed IDs like:
...
ClosedClaw may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `ClosedClaw models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
ClosedClaw models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
ClosedClaw models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
ClosedClaw models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
ClosedClaw models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

ClosedClaw supports both:
...
```
--port > ClosedClaw_GATEWAY_PORT > gateway.port > default 18789
```

### Why does ClosedClaw gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `ClosedClaw gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does ClosedClaw gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `ClosedClaw_STATE_DIR` mismatch).

Fix:

```bash
ClosedClaw gateway install --force
```
...
ClosedClaw enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `ClosedClaw gateway --port <port>`.

### How do I run ClosedClaw in remote mode client connects to a Gateway elsewhere
...
- `ClosedClaw gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `ClosedClaw.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:

- Fastest: `ClosedClaw dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `ClosedClaw doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `ClosedClaw_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `ClosedClaw status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `ClosedClaw_CONFIG_PATH` (per‑instance config)
- `ClosedClaw_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `ClosedClaw --profile <name> …` per instance (auto-creates `~/.ClosedClaw-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `ClosedClaw --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.ClosedClaw.*`, `ClosedClaw-gateway-<profile>.service`, `ClosedClaw Gateway (<profile>)`).
...
```
ClosedClaw tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/ClosedClaw/ClosedClaw-YYYY-MM-DD.log
```
...
- macOS: `$ClosedClaw_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.ClosedClaw/logs/...`; profiles use `~/.ClosedClaw-<profile>/logs/...`)
- Linux: `journalctl --user -u ClosedClaw-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "ClosedClaw Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `ClosedClaw gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart ClosedClaw
...
1. Is the Gateway running? `ClosedClaw gateway status`
2. Is the Gateway healthy? `ClosedClaw status`
3. Does the UI have the right token? `ClosedClaw dashboard`
...
```bash
ClosedClaw channels status
ClosedClaw channels logs --channel telegram
```
...
### ELI5 ClosedClaw gateway restart vs ClosedClaw gateway

- `ClosedClaw gateway restart`: restarts the **background service** (launchd/systemd).
- `ClosedClaw gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `ClosedClaw gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [ClosedClaw assistant setup](/start/ClosedClaw) and [Agent send](/tools/agent-send).

CLI sending:

```bash
ClosedClaw message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose ClosedClaw to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `ClosedClaw pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `ClosedClaw pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `ClosedClaw doctor` to surface risky DM policies.
...
```bash
ClosedClaw pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. ClosedClaw only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
ClosedClaw pairing approve whatsapp <code>
```

List pending requests:

```bash
ClosedClaw pairing list whatsapp
```
...
ClosedClaw blocks **cross‑provider** messaging by default. If a tool call is bound
...
**A:** In ClosedClaw, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn’t find Anthropic credentials in the expected `auth-profiles.json` for the agent that’s running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/ClosedClaw/ClosedClaw/discussions).
