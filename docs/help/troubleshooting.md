...
You can also set `ClosedClaw_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `ClosedClaw config get agents.defaults.models`
...
If you can, include the relevant log tail from `ClosedClaw logs --follow`.
