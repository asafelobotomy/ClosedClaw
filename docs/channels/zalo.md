...
- Install via CLI: `ClosedClaw plugins install @ClosedClaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `ClosedClaw plugins install ./extensions/zalo`
   - From npm (if published): `ClosedClaw plugins install @ClosedClaw/zalo`
...
- Approve via:
  - `ClosedClaw pairing list zalo`
  - `ClosedClaw pairing approve zalo <CODE>`
...
- Example: `ClosedClaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `ClosedClaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `ClosedClaw logs --follow`
