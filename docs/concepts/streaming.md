...
ClosedClaw has two separate “streaming” layers:
...
When block streaming is enabled, ClosedClaw can **merge consecutive block chunks**
...
When draft streaming is active, ClosedClaw disables block streaming for that reply to avoid double-streaming.
