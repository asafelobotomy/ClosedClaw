...
This page ties together how ClosedClaw handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. ClosedClaw keeps a
...
ClosedClaw separates the **prompt body** from the **command body**:
...
ClosedClaw can expose or hide model reasoning:
