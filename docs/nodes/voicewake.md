...
ClosedClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.ClosedClaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["ClosedClaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
