---
summary: "Use Qwen OAuth (free tier) in ClosedClaw"
read_when:
  - You want to use Qwen with ClosedClaw
...
If you already logged in with the Qwen Code CLI, ClosedClaw will sync credentials
