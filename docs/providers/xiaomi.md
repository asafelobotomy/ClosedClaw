---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ClosedClaw"
read_when:
  - You want Xiaomi MiMo models in ClosedClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ClosedClaw uses
