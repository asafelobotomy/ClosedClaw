...
export function listBlueBubblesAccountIds(cfg: ClosedClawConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: ClosedClawConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: ClosedClawConfig): ResolvedBlueBubblesAccount[] {
