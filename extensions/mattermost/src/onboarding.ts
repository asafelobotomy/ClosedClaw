import type { ChannelOnboardingAdapter, ClosedClawConfig, WizardPrompter } from "ClosedClaw/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.ClosedClaw.ai/channels/mattermost",
    ].join("\n"),
