...
- Version alignment with core ClosedClaw release numbers.
...
- First public release of the @ClosedClaw/voice-call plugin.
...
- CLI: `ClosedClaw voicecall` commands (call/start/continue/speak/end/status/tail/expose).
