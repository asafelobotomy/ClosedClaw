...
export function listZalouserAccountIds(cfg: ClosedClawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ClosedClawConfig): string {
...
function mergeZalouserAccountConfig(cfg: ClosedClawConfig, accountId: string): ZalouserAccountConfig {
