import type { LineChannelData, ClosedClawPluginApi, ReplyPayload } from "ClosedClaw/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: ClosedClawPluginApi): void {
  api.registerCommand({
    name: "card",
