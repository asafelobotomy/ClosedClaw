...
const SANDBOX_EXAMPLES = {
  main: [
    ["ClosedClaw sandbox list", "List all sandbox containers."],
    ["ClosedClaw sandbox list --browser", "List only browser containers."],
    ["ClosedClaw sandbox recreate --all", "Recreate all containers."],
    ["ClosedClaw sandbox recreate --session main", "Recreate a specific session."],
    ["ClosedClaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["ClosedClaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["ClosedClaw sandbox list", "List all sandbox containers."],
    ["ClosedClaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ...
    ["ClosedClaw sandbox recreate --session main", "Recreate a specific session."],
    [
      "ClosedClaw sandbox recreate --agent mybot",
      "Recreate a specific agent (includes sub-agents).",
    ],
    ["ClosedClaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["ClosedClaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["ClosedClaw sandbox explain", "Show effective sandbox config."],
    ["ClosedClaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["ClosedClaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["ClosedClaw sandbox explain --json", "JSON output."],
  ],
} as const;
