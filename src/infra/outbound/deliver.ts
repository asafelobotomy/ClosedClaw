...
// Third-party channel send function types removed — channels have been archived.
...
// Signal format/send removed — channel archived.
// markdownToSignalTextChunks and sendMessageSignal are no longer available.
import { normalizeReplyPayloadsForDelivery } from "./payloads.js";

export type { NormalizedOutboundPayload } from "./payloads.js";
export { normalizeOutboundPayloads } from "./payloads.js";

// All channel outbound flows through the plugin outbound adapter pipeline.
// No per-channel send deps are needed; GTK GUI uses loadChannelOutboundAdapter().
