...
import { createClosedClawCodingTools } from "./pi-tools.js";
...
describe("Agent-specific tool filtering", () => {
    ...
    const cfg: ClosedClawConfig = {
      ...
      agents: {
        list: [
          {
            id: "main",
            workspace: "~/ClosedClaw",
          },
        ],
      },
    };

    const tools = createClosedClawCodingTools({
      config: cfg,
    ...
    const cfg: ClosedClawConfig = {
      ...
      agents: {
        list: [
          {
            id: "restricted",
            workspace: "~/ClosedClaw-restricted",
            tools: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createClosedClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createClosedClawCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createClosedClawCodingTools({
      config: cfg,
    ...
    const defaultTools = createClosedClawCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createClosedClawCodingTools({
      config: cfg,
    ...
    const bobTools = createClosedClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createClosedClawCodingTools({
      config: cfg,
