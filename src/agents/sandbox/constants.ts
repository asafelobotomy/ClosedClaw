...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "closedclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "closedclaw-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "closedclaw-sbx-browser-";
