...
function resolveWatchPaths(workspaceDir: string, config?: ClosedClawConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ClosedClawConfig }) {
