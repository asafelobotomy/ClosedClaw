...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveClosedClawAgentDir() returns mainAgentDir
    process.env.ClosedClaw_STATE_DIR = tmpDir;
    process.env.ClosedClaw_AGENT_DIR = mainAgentDir;
