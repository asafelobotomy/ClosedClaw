...
function resolveAvatarSource(cfg: ClosedClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ClosedClawConfig, agentId: string): AgentAvatarResolution {
