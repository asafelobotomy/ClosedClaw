...
describe("createClosedClawCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createClosedClawCodingTools({
      config,
    ...
    const anthropicTools = createClosedClawCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createClosedClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createClosedClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
