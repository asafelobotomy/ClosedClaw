...
function resolveAnthropicDefaultAuthMode(cfg: ClosedClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ClosedClawConfig): ClosedClawConfig {
...
export function applyTalkApiKey(config: ClosedClawConfig): ClosedClawConfig {
...
export function applyModelDefaults(cfg: ClosedClawConfig): ClosedClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ClosedClawConfig): ClosedClawConfig {
...
export function applyLoggingDefaults(cfg: ClosedClawConfig): ClosedClawConfig {
...
export function applyContextPruningDefaults(cfg: ClosedClawConfig): ClosedClawConfig {
...
export function applyCompactionDefaults(cfg: ClosedClawConfig): ClosedClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
