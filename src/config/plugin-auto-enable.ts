...
function isTelegramConfigured(cfg: ClosedClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: ClosedClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: ClosedClawConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: ClosedClawConfig): boolean {
...
function isIMessageConfigured(cfg: ClosedClawConfig): boolean {
...
function isGenericChannelConfigured(cfg: ClosedClawConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: ClosedClawConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: ClosedClawConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: ClosedClawConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: ClosedClawConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: ClosedClawConfig, pluginId: string): ClosedClawConfig {
...
function enablePluginEntry(cfg: ClosedClawConfig, pluginId: string): ClosedClawConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
