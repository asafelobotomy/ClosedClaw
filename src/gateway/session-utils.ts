...
import { type ClosedClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ClosedClawConfig): string[] {
...
export function listAgentsForGateway(cfg: ClosedClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ClosedClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: ClosedClawConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: ClosedClawConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: ClosedClawConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: ClosedClawConfig): GatewaySessionsDefaults {
