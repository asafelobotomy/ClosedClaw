...
function listConfiguredAccountIds(cfg: ClosedClawConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: ClosedClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ClosedClawConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: ClosedClawConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: ClosedClawConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: ClosedClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ClosedClawConfig): ResolvedWhatsAppAccount[] {
