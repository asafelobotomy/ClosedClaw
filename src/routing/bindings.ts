...
export function listBindings(cfg: ClosedClawConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: ClosedClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ClosedClawConfig) {
