...
export type ChannelAgentToolFactory = (params: { cfg?: ClosedClawConfig }) => ChannelAgentTool[];
...
export type ChannelMentionAdapter = {
  stripPatterns?: (params: {
    ctx: MsgContext;
    cfg: ClosedClawConfig | undefined;
    agentId?: string;
  }) => string[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ClosedClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ClosedClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ClosedClawConfig }) => boolean;
  supportsCards?: (params: { cfg: ClosedClawConfig }) => boolean;
