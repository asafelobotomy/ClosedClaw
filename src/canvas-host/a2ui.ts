...
export const A2UI_PATH = "/__ClosedClaw__/a2ui";

export const CANVAS_HOST_PATH = "/__ClosedClaw__/canvas";

export const CANVAS_WS_PATH = "/__ClosedClaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.ClosedClawCanvasA2UIAction.postMessage(...)
  // - Android: window.ClosedClawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["ClosedClawCanvasA2UIAction"];
  ...
  globalThis.ClosedClaw = globalThis.ClosedClaw ?? {};
  globalThis.ClosedClaw.postMessage = postToNode;
  globalThis.ClosedClaw.sendUserAction = sendUserAction;
  globalThis.ClosedClawPostMessage = postToNode;
  globalThis.ClosedClawSendUserAction = sendUserAction;
