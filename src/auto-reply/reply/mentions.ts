...
function resolveMentionPatterns(cfg: ClosedClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ClosedClawConfig | undefined, agentId?: string): RegExp[] {
