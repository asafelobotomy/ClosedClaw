...
export const DEFAULT_LOG_DIR = "/tmp/ClosedClaw";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "ClosedClaw.log"); // legacy single-file path

const LOG_PREFIX = "ClosedClaw";
...
function resolveSettings(): ResolvedSettings {
  let cfg: ClosedClawConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => ClosedClawConfig;
      };
