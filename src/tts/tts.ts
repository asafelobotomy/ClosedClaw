...
export function resolveTtsConfig(cfg: ClosedClawConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.ClosedClaw_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: ClosedClawConfig): string | undefined {
...
function resolveOutputFormat(_channelId?: string | null) {
