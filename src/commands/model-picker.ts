...
function resolveConfiguredModelRaw(cfg: ClosedClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: ClosedClawConfig): string[] {
...
export function applyPrimaryModel(cfg: ClosedClawConfig, model: string): ClosedClawConfig {
...
export function applyModelAllowlist(cfg: ClosedClawConfig, models: string[]): ClosedClawConfig {
  const defaults = cfg.agents?.defaults;
