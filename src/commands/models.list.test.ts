...
const ensureClosedClawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveClosedClawAgentDir = vi.fn().mockReturnValue("/tmp/ClosedClaw-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/ClosedClaw-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureClosedClawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveClosedClawAgentDir,
}));
