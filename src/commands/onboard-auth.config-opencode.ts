...
export function applyOpencodeZenProviderConfig(cfg: ClosedClawConfig): ClosedClawConfig {
...
export function applyOpencodeZenConfig(cfg: ClosedClawConfig): ClosedClawConfig {
