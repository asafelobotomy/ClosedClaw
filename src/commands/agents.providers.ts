...
function resolveDefaultAccountId(cfg: ClosedClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ClosedClawConfig): boolean {
...
export function summarizeBindings(cfg: ClosedClawConfig, bindings: AgentBinding[]): string[] {
