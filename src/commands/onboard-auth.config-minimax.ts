...
export function applyMinimaxProviderConfig(cfg: ClosedClawConfig): ClosedClawConfig {
...
export function applyMinimaxConfig(cfg: ClosedClawConfig): ClosedClawConfig {
