...
import {
  ...
  type ClosedClawPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @ClosedClaw/voice-call -> voice-call).
...
export function discoverClosedClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".ClosedClaw", "extensions")];
