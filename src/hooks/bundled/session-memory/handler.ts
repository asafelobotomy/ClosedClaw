...
const saveSessionToMemory: HookHandler = async (event) => {
  ...
  try {
    ...
    const workspaceDir = cfg
      ...
      : path.join(os.homedir(), ".ClosedClaw", "workspace");
    ...
    if (sessionFile) {
      ...
      if (sessionContent && cfg) {
        ...
        const ClosedClawRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "../..");
        const slugGenPath = path.join(ClosedClawRoot, "llm-slug-generator.js");
