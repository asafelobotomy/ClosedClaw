...
import type { ClosedClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: ClosedClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: ClosedClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
