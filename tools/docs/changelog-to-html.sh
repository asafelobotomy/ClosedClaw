...
if [[ -z "$version_content" ]]; then
  echo "<h2>ClosedClaw $VERSION</h2>"
  echo "<p>Latest ClosedClaw update.</p>"
  echo "<p><a href=\"https://github.com/ClosedClaw/ClosedClaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
