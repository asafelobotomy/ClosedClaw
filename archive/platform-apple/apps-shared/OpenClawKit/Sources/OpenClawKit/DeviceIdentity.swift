...
enum DeviceIdentityPaths {
    private static let stateDirEnv = ["ClosedClaw_STATE_DIR"]
    ...
    static func stateDirURL() -> URL {
        ...
        if let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            return appSupport.appendingPathComponent("ClosedClaw", isDirectory: true)
        }

        return FileManager.default.temporaryDirectory.appendingPathComponent("ClosedClaw", isDirectory: true)
    }
}
