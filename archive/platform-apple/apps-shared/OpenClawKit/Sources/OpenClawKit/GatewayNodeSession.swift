...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.ClosedClaw", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.ClosedClaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: ClosedClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
