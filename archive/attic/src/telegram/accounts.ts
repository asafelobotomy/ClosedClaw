...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ClosedClaw_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ClosedClawConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ClosedClawConfig): string {
...
export function listEnabledTelegramAccounts(cfg: ClosedClawConfig): ResolvedTelegramAccount[] {
