...
import { DELAY_RECONNECT_INITIAL_MS, DELAY_RECONNECT_MAX_MS } from "../config/constants/index.js";
...
export function resolveHeartbeatSeconds(cfg: ClosedClawConfig, overrideSeconds?: number): number {
