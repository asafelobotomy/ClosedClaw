...
Nostr DM channel plugin for ClosedClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to ClosedClaw. It enables your bot to:
...
# Configure ClosedClaw to use local relay
