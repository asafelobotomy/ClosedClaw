...
export function listGoogleChatAccountIds(cfg: ClosedClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ClosedClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ClosedClawConfig): ResolvedGoogleChatAccount[] {
