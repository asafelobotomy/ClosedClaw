...
const outPaths = [
  path.join(repoRoot, "apps", "macos", "Sources", "ClosedClawProtocol", "GatewayModels.swift"),
  path.join(
    repoRoot,
    "apps",
    "shared",
...
const header = `// Generated by tools/maintenance/protocol-gen-swift.ts — do not edit by hand\nimport Foundation\n\npublic let GATEWAY_PROTOCOL_VERSION = ${PROTOCOL_VERSION}\n\npublic enum ErrorCode: String, Codable, Sendable {\n${Object.values(
  ErrorCodes,
)
  .map((c) => {
    const code = typeof c === "string" ? c : String(c);
    return `    case ${camelCase(code)} = "${code}"`;
  })
  .join("\n")}\n}\n`;
