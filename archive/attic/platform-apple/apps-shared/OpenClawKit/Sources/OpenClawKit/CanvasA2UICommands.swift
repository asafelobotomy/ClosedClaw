...
public enum ClosedClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct ClosedClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ClosedClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
