...
export function listMattermostAccountIds(cfg: ClosedClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ClosedClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ClosedClawConfig): ResolvedMattermostAccount[] {
