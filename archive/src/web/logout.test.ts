...
describe("web logout", () => {
  ...
  it("deletes cached credentials when present", { timeout: TIMEOUT_TEST_SUITE_LONG_MS }, async () => {
  ...
  it("no-ops when nothing to delete", { timeout: TIMEOUT_TEST_SUITE_LONG_MS }, async () => {
