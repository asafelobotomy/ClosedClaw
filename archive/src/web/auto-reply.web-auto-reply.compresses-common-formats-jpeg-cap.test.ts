...
import { TIMEOUT_TEST_SUITE_EXTENDED_MS } from "../config/constants/index.js";
...
describe("web auto-reply", () => {
  ...
  it("compresses common formats to jpeg under the cap", { timeout: TIMEOUT_TEST_SUITE_EXTENDED_MS }, async () => {
    const formats = [
      {
        name: "png",
        mime: "image/png",
