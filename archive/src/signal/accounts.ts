...
export function listSignalAccountIds(cfg: ClosedClawConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: ClosedClawConfig): string {
...
export function listEnabledSignalAccounts(cfg: ClosedClawConfig): ResolvedSignalAccount[] {
