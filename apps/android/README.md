## ClosedClaw Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_ClosedClaw-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm ClosedClaw gateway --port 18789 --verbose
```
