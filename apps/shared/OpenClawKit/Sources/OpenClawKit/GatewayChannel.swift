...
private typealias ProtoAnyCodable = ClosedClawProtocol.AnyCodable
...
public actor GatewayChannelActor {
    private let logger = Logger(subsystem: "ai.ClosedClaw", category: "gateway")
